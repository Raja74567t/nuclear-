...
bot = telebot.TeleBot('8098653136:AAEyIcP6XvabF17ZyVOkt3I-E01VWBBUXN4')
...
def authorize_user(message, func):
    ...
    if is_key_valid(message.text):
        ...
        bot.reply_to(message, "❌YOU HAVE NO KEY DM TO BUY @NNUCLEAR_OP🚀")    
...
Buy From :- @NNUCLEAR_OP 🚀

Official Channel :- https://t.me/deltaddosjet
'''
...
➡️ Join Telegram :- https://t.me/deltaddosjet'''
